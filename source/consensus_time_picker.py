...
# t1 = time.time()
# g1.get_consensus_single_proc(0, 0, 'testing_consensus')
# t1 = time.time() - t1
...
# try:
#     with open("./rsm_cons_time_times.txt", 'a') as file:
#         file.write(f"5, 1 : {t1}\n")
...
def plot_bar_chart(data):
    ...
    plt.ylabel('Time [s]')
    plt.title('Consensus between RSMs time detection')
...
data = read_data_file("rsm_cons_time_times.txt")
plot_bar_chart(data)
